...
export default function Dashboard() {
  ...
  const { riskScores, alerts, riskGrid, isConnected, lastUpdated } = useBackendData();
        ...
        <div className="flex flex-1 overflow-hidden gap-6">
          ...
          <main className="flex-1 relative flex flex-col rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/[0.05]">
            ...
            <div className="absolute inset-0 z-0">
              <RiskMap riskGrid={riskGrid} filter={activeTab === 'alerts' || activeTab === 'routes' || activeTab === 'rescue' ? 'all' : activeTab} />
            </div>
